...
<head>
    ...
    <title>Creativerse - Technology IT Solutions</title>
                                ...
                                <div class="header-right-inner" id="hidden-icon-wrapper">
                                    ...
                                    <div class="language-menu">
                                        <ul>
                                            <li>
                                                <a href="#" class="">
                                                    <img class="ls-flag" src="{{ URL::asset('assets/images/flags/en.png') }}" alt="en" title="English">
                                                ...
                                                <ul class="ls-sub-menu">
                                                    <li class="">
                                                        <a href="#" class="">
                                                            <img class="ls-flag" src="{{ URL::asset('assets/images/flags/fr.png') }}" alt="en" title="Français"><span class="wpml-ls-native">Français</span>
                                                        </a>
                                                    </li>
                                                    <li class="">
                                                        <a href="#" class="">
                                                            <img class="wpml-ls-flag" src="{{ URL::asset('assets/images/flags/de.png') }}" alt="de" title="Deutsch"><span class="wpml-ls-native">Deutsch</span>
                                                        </a>
                                                    </li>
                                        ...
                                        <div class="box-large-image__box">
                                            <div class="box-large-image__midea">
                                                <div class="images-midea">
                                                    <img src="{{ URL::asset('assets/images/box-image/blog-01-330x330.jpg') }}" class="img-fluid" alt="">
                                ...
                                <div class="col-lg-4 col-md-6  mt-30">
                                    ...
                                    <a href="#" class="box-large-image__wrap wow move-up">
                                        <div class="box-large-image__box">
                                            <div class="box-large-image__midea">
                                                <div class="images-midea">
                                                    <img src="{{ URL::asset('assets/images/box-image/mitech-home-infotechno-box-large-image-02-330x330.jpg') }}" class="img-fluid" alt="">
                                ...
                                <div class="col-lg-4 col-md-6  mt-30">
                                    ...
                                    <a href="#" class="box-large-image__wrap wow move-up">
                                        <div class="box-large-image__box">
                                            <div class="box-large-image__midea">
                                                <div class="images-midea">
                                                    <img src="{{ URL::asset('assets/images/box-image/mitech-home-infotechno-box-large-image-03-330x330.jpg') }}" class="img-fluid" alt="">
                            ...
                            <div class="swiper-wrapper">
                                    ...
                                    <a href="#" class="projects-wrap style-01 wow move-up">
                                        <div class="projects-image-box">
                                            <div class="projects-image">
                                                <img class="img-fluid" src="{{ URL::asset('assets/images/projects/case-study-01-480x298.jpg') }}" alt="">
                                            </div>
                                            <div class="content">
                                ...
                                <div class="swiper-slide">
                                    ...
                                    <a href="#" class="projects-wrap style-01 wow move-up">
                                        <div class="projects-image-box">
                                            <div class="projects-image">
                                                <img class="img-fluid" src="{{ URL::asset('assets/images/projects/case-study-02-480x298.jpg') }}" alt="">
                                            </div>
                                            <div class="content">
                                ...
                                <div class="swiper-slide">
                                    ...
                                    <a href="#" class="projects-wrap style-01 wow move-up">
                                        <div class="projects-image-box">
                                            <div class="projects-image">
                                                <img class="img-fluid" src="{{ URL::asset('assets/images/projects/case-study-03-480x298.jpg') }}" alt="">
                                            </div>
                                            <div class="content">
                                ...
                                <div class="swiper-slide">
                                    ...
                                    <a href="#" class="projects-wrap style-01 wow move-up">
                                        <div class="projects-image-box">
                                            <div class="projects-image">
                                                <img class="img-fluid" src="{{ URL::asset('assets/images/projects/case-study-04-480x298.jpg') }}" alt="">
                                            </div>
                                            <div class="content">
